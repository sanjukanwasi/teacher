...
<div class="herald-ovrld">	
	...
	<?php if ( $fimg = herald_get_featured_image( 'herald-lay-a1' ) ) : ?>
	...
	<div class="entry-header herald-pf">
		<?php if( herald_get_option( 'lay_a1_cat' ) ) : ?>
		...
		<?php if( $meta = herald_get_meta_data( 'a1' ) ) : ?>
			<div class="entry-meta"><?php echo $meta; ?></div>
		<?php endif; ?>
	</div>
</div>

	<?php if( herald_get_option('lay_a1_excerpt') ) : ?>
		<div class="col-mod">
			<div class="entry-content">
				<?php echo herald_get_excerpt( 'a1' ); ?>
			</div>
			<?php if( herald_get_option('lay_a1_rm') ) : ?>
