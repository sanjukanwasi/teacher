...
Redux::setSection( $opt_name , array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'default' =>  __( 'Copyright &copy; 2015. Created by <a href="http://mekshq.com" target="_blank">Meks</a>. Powered by <a href="http://www.wordpress.org" target="_blank">WordPress</a>.', 'herald' ),
                'args'   => array(
                    'textarea_rows'    => 3  ,
                    'default_editor' => 'html'                          ),
...
Redux::setSection( $opt_name , array(
        ...
        'fields'    => array(
            ...
            array(
                'id' => 'lay_a_excerpt',
                'type' => 'switch',
                'title' => esc_html__( 'Layout A excerpt', 'herald' ),
                'subtitle' => esc_html__( 'Check if you want to show a text excerpt for posts in Layout A', 'herald' ),
                'default' => true
            ),
...
Redux::setSection( $opt_name , array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'subtitle' => esc_html__( 'Paste specific WordPress language <a href="http://wpcentral.io/internationalization/" target="_blank">locale code</a> to exclude it from the RTL mode', 'herald' ),
